...
curl.exe -fL --retry 5 --retry-delay 3 -o "%OUT%" "https://github.com/erfae/gadirtv-android/releases/download/v2.4.7/GadirTV-AndroidTV.apk"
...
goto :eof
:fail
echo ERROR. Abre: github.com/erfae/gadirtv-android/releases/tag/v2.4.7
exit /b 1
