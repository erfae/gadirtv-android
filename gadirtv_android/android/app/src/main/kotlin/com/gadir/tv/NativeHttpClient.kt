...
/**
 * OkHttp-based Xtream API client — same HTTP stack XCIPTV / IPTV Smarters use.
 * [HttpURLConnection] alone was still getting HTTP 512 on some panels.
 */
object NativeHttpClient {
    ...
    fun request(url: String, userAgent: String, method: String): Map<String, Any> {
        val uri = URI(url)
        val portPart = when {
            uri.port == -1 -> ""
