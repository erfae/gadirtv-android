...
.method private copyOrUpdate(Lio/realm/RealmModel;ZLjava/util/Map;Ljava/util/Set;)Lio/realm/RealmModel;
    ...
    move-result-object p1
    :try_end_2c
    .catch Ljava/lang/IllegalStateException; {:try_start_1d .. :try_end_2c} :catch_2d
...
.method public static getDefaultModule()Ljava/lang/Object;
    ...
    move-result-object v0
    :try_end_15
    .catch Ljava/lang/ClassNotFoundException; {:try_start_2 .. :try_end_15} :catch_2b
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_2 .. :try_end_15} :catch_24
    .catch Ljava/lang/InstantiationException; {:try_start_2 .. :try_end_15} :catch_1d
...
.method public createAllFromJson(Ljava/lang/Class;Lorg/json/JSONArray;)V
    ...
    :try_end_1d
    .catch Lorg/json/JSONException; {:try_start_10 .. :try_end_1d} :catch_20
...
.method public createObjectFromJson(Ljava/lang/Class;Ljava/io/InputStream;)Lio/realm/RealmModel;
    ...
    move-result-object p1
    :try_end_33
    .catch Lorg/json/JSONException; {:try_start_1b .. :try_end_33} :catch_39
...
.method public createObjectFromJson(Ljava/lang/Class;Ljava/lang/String;)Lio/realm/RealmModel;
    ...
    :try_end_10
    .catch Lorg/json/JSONException; {:try_start_b .. :try_end_10} :catch_15
...
.method public createOrUpdateAllFromJson(Ljava/lang/Class;Ljava/io/InputStream;)V
    ...
    :try_end_2e
    .catch Lorg/json/JSONException; {:try_start_c .. :try_end_2e} :catch_37
    .catchall {:try_start_c .. :try_end_2e} :catchall_35
...
.method public createOrUpdateAllFromJson(Ljava/lang/Class;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p2}, Lorg/json/JSONArray;-><init>(Ljava/lang/String;)V
    :try_end_16
    .catch Lorg/json/JSONException; {:try_start_11 .. :try_end_16} :catch_1a
...
.method public createOrUpdateAllFromJson(Ljava/lang/Class;Lorg/json/JSONArray;)V
    ...
    :try_end_20
    .catch Lorg/json/JSONException; {:try_start_12 .. :try_end_20} :catch_23
...
.method public createOrUpdateObjectFromJson(Ljava/lang/Class;Ljava/io/InputStream;)Lio/realm/RealmModel;
    ...
    move-result-object p1
    :try_end_1d
    .catch Lorg/json/JSONException; {:try_start_c .. :try_end_1d} :catch_23
...
.method public createOrUpdateObjectFromJson(Ljava/lang/Class;Ljava/lang/String;)Lio/realm/RealmModel;
    ...
    invoke-direct {v0, p2}, Lorg/json/JSONObject;-><init>(Ljava/lang/String;)V
    :try_end_16
    .catch Lorg/json/JSONException; {:try_start_11 .. :try_end_16} :catch_1b
