...
# instance fields
.field private final zzlo:Lcom/google/android/gms/cast/framework/zzt;

.field private final zzlp:Landroid/content/Context;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/cast/framework/SessionManager;->zzy:Lcom/google/android/gms/cast/internal/Logger;

    return-void
.end method

.method public constructor <init>(Lcom/google/android/gms/cast/framework/zzt;Landroid/content/Context;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/gms/cast/framework/SessionManager;->zzlo:Lcom/google/android/gms/cast/framework/zzt;

    .line 3
    iput-object p2, p0, Lcom/google/android/gms/cast/framework/SessionManager;->zzlp:Landroid/content/Context;
...
.method final addCastStateListener(Lcom/google/android/gms/cast/framework/CastStateListener;)V
    ...
    .line 77
    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/cast/framework/SessionManager;->zzlo:Lcom/google/android/gms/cast/framework/zzt;

    new-instance v1, Lcom/google/android/gms/cast/framework/zze;

    invoke-direct {v1, p1}, Lcom/google/android/gms/cast/framework/zze;-><init>(Lcom/google/android/gms/cast/framework/CastStateListener;)V

    invoke-interface {v0, v1}, Lcom/google/android/gms/cast/framework/zzt;->zza(Lcom/google/android/gms/cast/framework/zzl;)V
    :try_end_0
    ...
    .line 80
    sget-object v0, Lcom/google/android/gms/cast/framework/SessionManager;->zzy:Lcom/google/android/gms/cast/internal/Logger;
...
.method public addSessionManagerListener(Lcom/google/android/gms/cast/framework/SessionManagerListener;Ljava/lang/Class;)V
    ...
    new-instance v1, Lcom/google/android/gms/cast/framework/zzad;

    invoke-direct {v1, p1, p2}, Lcom/google/android/gms/cast/framework/zzad;-><init>(Lcom/google/android/gms/cast/framework/SessionManagerListener;Ljava/lang/Class;)V

    invoke-interface {v0, v1}, Lcom/google/android/gms/cast/framework/zzt;->zza(Lcom/google/android/gms/cast/framework/zzv;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 35
    sget-object p2, Lcom/google/android/gms/cast/framework/SessionManager;->zzy:Lcom/google/android/gms/cast/internal/Logger;
...
.method public endCurrentSession(Z)V
    ...
    .line 18
    :try_start_0
    sget-object v2, Lcom/google/android/gms/cast/framework/SessionManager;->zzy:Lcom/google/android/gms/cast/internal/Logger;

    const-string v3, "End session for %s"

    new-array v4, v1, [Ljava/lang/Object;

    iget-object v5, p0, Lcom/google/android/gms/cast/framework/SessionManager;->zzlp:Landroid/content/Context;
    ...
    .line 19
    iget-object v2, p0, Lcom/google/android/gms/cast/framework/SessionManager;->zzlo:Lcom/google/android/gms/cast/framework/zzt;

    invoke-interface {v2, v1, p1}, Lcom/google/android/gms/cast/framework/zzt;->zza(ZZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method final getCastState()I
    ...
    invoke-interface {v0}, Lcom/google/android/gms/cast/framework/zzt;->getCastState()I
    ...
    .line 72
    sget-object v1, Lcom/google/android/gms/cast/framework/SessionManager;->zzy:Lcom/google/android/gms/cast/internal/Logger;
...
.method public getCurrentSession()Lcom/google/android/gms/cast/framework/Session;
    ...
    invoke-interface {v0}, Lcom/google/android/gms/cast/framework/zzt;->zzak()Lcom/google/android/gms/dynamic/IObjectWrapper;
...
.method final removeCastStateListener(Lcom/google/android/gms/cast/framework/CastStateListener;)V
    ...
    invoke-interface {v0, v1}, Lcom/google/android/gms/cast/framework/zzt;->zzb(Lcom/google/android/gms/cast/framework/zzl;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public removeSessionManagerListener(Lcom/google/android/gms/cast/framework/SessionManagerListener;Ljava/lang/Class;)V
    ...
    invoke-interface {v0, v1}, Lcom/google/android/gms/cast/framework/zzt;->zzb(Lcom/google/android/gms/cast/framework/zzv;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public startSession(Landroid/content/Intent;)V
    ...
    .line 53
    :try_start_0
    sget-object v3, Lcom/google/android/gms/cast/framework/SessionManager;->zzy:Lcom/google/android/gms/cast/internal/Logger;

    const-string v4, "Start session for %s"

    new-array v5, v1, [Ljava/lang/Object;

    iget-object v6, p0, Lcom/google/android/gms/cast/framework/SessionManager;->zzlp:Landroid/content/Context;
    ...
    .line 62
    :cond_1
    iget-object v4, p0, Lcom/google/android/gms/cast/framework/SessionManager;->zzlo:Lcom/google/android/gms/cast/framework/zzt;

    new-instance v5, Landroid/os/Bundle;

    invoke-direct {v5, v3}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-interface {v4, v5}, Lcom/google/android/gms/cast/framework/zzt;->zzd(Landroid/os/Bundle;)V
...
.method public final zzae()Lcom/google/android/gms/dynamic/IObjectWrapper;
    ...
    invoke-interface {v0}, Lcom/google/android/gms/cast/framework/zzt;->zzai()Lcom/google/android/gms/dynamic/IObjectWrapper;
