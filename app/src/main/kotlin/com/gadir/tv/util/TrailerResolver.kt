...
sealed class TrailerSource {
    ...
    /** YouTube id → MP4 vía Invidious/Piped. Nunca abre la app de YouTube. */
...
object TrailerResolver {
    ...
    fun isYoutubeUrl(url: String): Boolean {
        ...
        return YoutubeTrailerHelper.extractId(url) != null
    }
    ...
    fun firstPlayableUrl(sources: List<TrailerSource>): String? {
        for (source in sources) {
            when (source) {
                ...
                is TrailerSource.StreamVideo -> return "yt:${source.videoId}"
