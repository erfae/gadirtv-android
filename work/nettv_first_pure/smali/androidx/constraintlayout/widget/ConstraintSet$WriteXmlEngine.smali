...
.method public final getName(I)Ljava/lang/String;
    ...
    iget v4, p0, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->unknownCount:I
...
.method public final writeLayout()V
    ...
    invoke-virtual {p0, v3, v2}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v10, v2, v9}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeDimension(Ljava/lang/String;II)V
    ...
    const-string v10, "app:barrierAllowsGoneWidgets"

    invoke-direct {p0, v10, v2, v9}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeBoolen(Ljava/lang/String;ZZ)V
    ...
    invoke-virtual {p0, v10, v2, v9}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;FF)V

    .line 44
    iget v2, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->baselineToBaseline:I

    const-string v9, "app:baselineToBaseline"

    invoke-virtual {p0, v9, v2}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeXmlConstraint(Ljava/lang/String;I)V

    .line 45
    iget v2, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->baselineToBottom:I

    const-string v9, "app:baselineToBottom"
    ...
    const-string v9, "app:baselineToTop"
    ...
    const-string v9, "app:layout_constraintBottom_toBottomOf"
    ...
    const-string v9, "app:layout_constraintBottom_toTopOf"
    ...
    const-string v9, "app:layout_constraintEnd_toEndOf"
    ...
    const-string v9, "app:layout_constraintEnd_toStartOf"
    ...
    const-string v9, "app:layout_constraintLeft_toLeftOf"
    ...
    const-string v9, "app:layout_constraintLeft_toRightOf"
    ...
    const-string v9, "app:layout_constraintRight_toLeftOf"
    ...
    const-string v9, "app:layout_constraintRight_toRightOf"
    ...
    const-string v9, "app:layout_constraintStart_toEndOf"
    ...
    const-string v9, "app:layout_constraintStart_toStartOf"
    ...
    const-string v9, "app:layout_constraintTop_toBottomOf"
    ...
    const-string v9, "app:layout_constraintTop_toTopOf"

    invoke-virtual {p0, v9, v2}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeXmlConstraint(Ljava/lang/String;I)V

    const-string/jumbo v2, "spread"

    const-string/jumbo v9, "wrap"
    ...
    .line 60
    iget v9, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->heightDefault:I

    const-string v10, "app:layout_constraintHeight_default"

    invoke-direct {p0, v10, v9, v2, v8}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeEnum(Ljava/lang/String;I[Ljava/lang/String;I)V

    .line 61
    iget v9, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->heightPercent:F

    const/high16 v10, 0x3f800000    # 1.0f

    const-string v11, "app:layout_constraintHeight_percent"

    invoke-virtual {p0, v11, v9, v10}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;FF)V

    .line 62
    iget v9, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->heightMin:I

    const-string v10, "app:layout_constraintHeight_min"

    invoke-direct {p0, v10, v9, v8}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeDimension(Ljava/lang/String;II)V

    .line 63
    iget v9, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->heightMax:I
    ...
    .line 64
    iget-boolean v9, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->constrainedHeight:Z

    const-string v10, "android:layout_constrainedHeight"

    invoke-direct {p0, v10, v9, v8}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeBoolen(Ljava/lang/String;ZZ)V

    .line 65
    iget v9, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->widthDefault:I
    ...
    const-string v10, "app:layout_constraintWidth_percent"
    ...
    invoke-virtual {p0, v3, v2, v9}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;FF)V
    ...
    invoke-virtual {p0, v4}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->getName(I)Ljava/lang/String;
...
.method public final writeXmlConstraint(Ljava/lang/String;I)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
