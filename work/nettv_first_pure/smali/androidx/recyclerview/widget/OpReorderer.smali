...
.method private swapMoveOp(Ljava/util/List;II)V
    ...
    .line 5
    iput v5, v6, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->positionStart:I
    ...
    invoke-interface {v0, v3, v5, v1, v7}, Landroidx/recyclerview/widget/OpReorderer$Callback;->obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;
    ...
    iget-object v1, v6, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->payload:Ljava/lang/Object;

    invoke-interface {v2, v3, v5, v7, v1}, Landroidx/recyclerview/widget/OpReorderer$Callback;->obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;
    ...
    :cond_4
    :goto_2
    invoke-interface {p1, p3, v4}, Ljava/util/List;->set(ILjava/lang/Object;)Ljava/lang/Object;

    .line 15
    iget p3, v6, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->itemCount:I

    if-lez p3, :cond_5

    .line 16
    invoke-interface {p1, p2, v6}, Ljava/util/List;->set(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p3, v6}, Landroidx/recyclerview/widget/OpReorderer$Callback;->recycleUpdateOp(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    .line 21
    :cond_7
    iget v0, v4, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->positionStart:I
    ...
    .line 28
    iput v3, v4, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->cmd:I

    .line 29
    iput v1, v4, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->itemCount:I

    .line 30
    iget p2, v6, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->itemCount:I
    ...
    invoke-interface {p1, v6}, Landroidx/recyclerview/widget/OpReorderer$Callback;->recycleUpdateOp(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-interface {v9, v3, v5, v8, v2}, Landroidx/recyclerview/widget/OpReorderer$Callback;->obtainUpdateOp(IIILjava/lang/Object;)Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;
    ...
    iget v3, v6, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->positionStart:I
    ...
    invoke-interface {p1, v4}, Landroidx/recyclerview/widget/OpReorderer$Callback;->recycleUpdateOp(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    iget v1, v2, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->positionStart:I
    ...
    iput v0, v4, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->positionStart:I
    ...
    iput v0, v4, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->itemCount:I
...
# virtual methods
.method public final reorderOps(Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
